...
<div class="list-stadium">
	<div class="list-stadium-top">
		<div class="container">
			<div class="col-sm-12">
				<h3 class="subtitle">FAVOURITE COURSE</h3>
				<hr class="hrhr">
			</div>
			<div class="col-sm-12">
				<div class="card-deck">
	...
	<div id="list-stadium-between">
		<div class="container">
			<div class="col-sm-12">
				<h3 class="subtitle">HOT DEAL</h3>
				<hr class="hrhrhotdeal">
			</div>
			<div class="col-sm-12">
				<div class="card-deck">
					  <div class="card">
					    ...
					    <div class="card-body">
					      ...
					      <div class="d-flex bd-highlight">
							  ...
							  <div class="p-2 w-100 bd-highlight submarine">
							  	<a href="#" class="btn btn-outline-success intro-dk">Đăng ký</a>
							  </div>
						  </div>
					    </div>
					  </div>
		...
		<div class="row">
			<div class="col col-lg-12">
				<div class="section-title">
					<h1 class="text-center"><span>Golf Course Partner</span></h1>
				</div>
			</div>
		</div>
